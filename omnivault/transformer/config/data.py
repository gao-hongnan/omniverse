...
class DataConfig(BaseModel):
    ...
    dataset_name: str = Field(  # type: ignore[assignment]  # None default for DataConfig() factory; set from config
        default=None,
    ...
    dataset_path: str = Field(default=None, description="The path to the dataset.")  # type: ignore[assignment]  # None default for DataConfig() factory; set from config
    dataset_dir: str = Field(default=None, description="The directory to the dataset.")  # type: ignore[assignment]  # None default for DataConfig() factory; set from config
    dataset_url: str = Field(default=None, description="The url to the dataset.")  # type: ignore[assignment]  # None default for DataConfig() factory; set from config
    ...
    def coerce_collate_fn(cls: Type[DataConfig], v: Union[Dict[str, Any], NotGiven, None]) -> Dict[str, Any]:  # pyright: ignore[reportGeneralTypeIssues]
        if v is None:
            return {}
