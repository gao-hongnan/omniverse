...
readonly ALLOWED_CONFIG_FILES=("pyproject.toml", "isort.cfg")
readonly TOOL="isort"
...
show_usage() {
    ...
    logger "LINK" "https://pycqa.github.io/${TOOL}/index.html"
    logger "LINK" "https://pycqa.github.io/${TOOL}/docs/configuration/black_compatibility.html"
