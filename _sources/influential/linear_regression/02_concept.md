...
> Notation is not consistent when using $\hat{h}$ and $h$ in the
> problem formulation section. Same for $\hat{\boldsymbol{\beta}}$ and
...
(see section 3.1.1 of {cite}`bishop_2016`). Under this assumption, then it is easy to see that
...
See section 3.1.1. of {cite}`bishop_2016` for more details.
